  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen gap-4">
      {TestNum === 0 && 
        ...
        <Title size="2" className="text-black">나의 디자인 성향은?</Title>

          <Text size="1" className="text-gray-600 mt-5">디자이너라고 모두가 같은 성격을 가지고 있지는 않죠. <br /> 디플과 함께 숨겨진 나만의 디자인 성향을 발견해보세요!</Text>
        </div>
      ...
      {TestNum === 1 && 
        <Flex>
          ...
          <Quest>
            <div className="justify-start items-start text-2xl font-bold text-purple-500">Q1</div><br/>
            🏢 회사 첫 출근날, 내 자리를 세팅한 뒤 나는</Quest><br/><br/><br/><br/><br/>
      ...
      {TestNum === 2 && 
        <Flex>
          ...
          <Quest>
          <div className="text-2xl font-bold text-purple-500">Q2</div><br/>
            💡 재밌을 것 같은 아이디어가 번뜩 떠올랐을 때 나는</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{mbti.E += 1; nextTestNum(TestNum + 1);}}>
      ...
      {TestNum === 3 && 
        <Flex>
          ...
          <Quest>
          <div className="text-2xl font-bold text-purple-500">Q3</div><br/>
            🤔 아무리 디자인 작업을 해도 어딘가 만족스럽지<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;못 할 경우에 나는</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{mbti.E += 1; nextTestNum(TestNum + 1);}}>
      ...
      {TestNum === 4 && 
        <Flex>
          ...
          <Quest>
            <div className="text-2xl font-bold text-purple-500">Q4</div><br/>
            😱 오늘안에 급하게 시안을 바꿔야 한다면</Quest><br/><br/><br/><br/><br/>
      ...
      {TestNum === 5 && 
        ...
        <div className="font-bold text-right text-gray-300 ">5 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q5</div><br/>
            💬 내가 선호하는 피드백은</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{mbti.S += 1; nextTestNum(TestNum + 1);}}>
      ...
      {TestNum === 6 && 
        ...
        <div className="font-bold text-right text-gray-300 ">6 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q6</div><br/>
            😇 마감기한이 다가오는데 작업하기 싫을 때</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{mbti.S += 1; nextTestNum(TestNum + 1);}}>
              이유는 없다. 그냥 하기 싫다.</Button><br/>
            <Button size="1" color="1" onClick={()=>{mbti.N += 1; nextTestNum(TestNum + 1);}}>
              내가 이 일을 왜 해야하지? 도망가면 어떻게 될까? 상상의 나래 시작</Button>
              </Flex>
        }   
      {TestNum === 7 && 
        <Flex>
        ...
        <div className="font-bold text-right text-gray-300 ">7 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q7</div><br/>
            🖥️ 내가 선호하는 작업 방식은</Quest><br/><br/><br/><br/><br/>
      ...
      {TestNum === 8 && 
       <Flex>
        ...
        <div className="font-bold text-right text-gray-300 ">8 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q8</div><br/>
            ✌️ 디자인할 때 내가 자신있는 부분은</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{ mbti.T += 1; nextTestNum(TestNum + 1);}}>
      ...
      {TestNum === 9 && 
        ...
        <div className="font-bold text-right text-gray-300 ">9 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q9</div><br/>
            👀 동료 디자이너가 새로운 툴을 추천해줬을 때</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{ mbti.T += 1; nextTestNum(TestNum + 1);}}>
      ...
      {TestNum === 10 && 
        ...
        <div className="font-bold text-right text-gray-300 ">10 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q10</div><br/>
            📁 디자인 작업할 때 내 파일은</Quest><br/><br/><br/><br/><br/>
            ...
            <Button size="1" color="1" onClick={()=>{ mbti.P += 1; nextTestNum(TestNum + 1);}}>
              최종.psd, 제발최종.psd.. 그 때 그 때 기분에 따라 바탕화면에 널려 있다</Button>
              </Flex>
        }   
      {TestNum === 11 && 
      <Flex>
        ...
        <div className="font-bold text-right text-gray-300 ">11 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q11</div><br/>
            📗 내 포트폴리오에 넣고 싶은 작업은</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{ mbti.J += 1; nextTestNum(TestNum + 1);}}>
      ...
      {TestNum === 12 && 
        ...
        <div className="font-bold text-right text-gray-300 ">12 / 12</div>
          ...
          <Quest><div className="text-2xl font-bold text-purple-500">Q12</div><br/>
            ⚠️ '응답 없음' 이 떴을 때 나는</Quest><br/><br/><br/><br/><br/>
            <Button size="1" color="1" onClick={()=>{ mbti.J += 1; nextTestNum(TestNum + 1);}}>
      ...
      <Flex>
          {TestNum === 0 && <Button className="font-extralight" size="1" color="2" onClick={()=>{nextTestNum(TestNum + 1)}}>
            나의 디자인 성향 찾기
          </Button>
          }
     </Flex>
